...
resource "aws_instance" "default" {
  ...
  iam_instance_profile                 = var.instance_profile_enabled == "true" ? join("", aws_iam_instance_profile.default.*.name) : ""
...
resource "aws_eip" "default" {
  count = var.instance_enabled && var.assign_eip_address ? var.instance_count : 0
...
resource "aws_ebs_volume" "default" {
  count = var.instance_enabled && var.ebs_volume_enabled ? var.instance_count : 0
...
resource "aws_iam_instance_profile" "default" {
  count = var.instance_enabled && var.instance_profile_enabled ? 1 : 0
...
resource "aws_route53_record" "default" {
  count   = var.instance_enabled && var.dns_enabled ? var.instance_count : 0
